# `angular-js-resigtation-with-Firebase` — 
In this Project we will create Fully Working Angular JS Registration Application with Google Firebase.
...
To get started just clone the repository from github.

### Prerequisites

To Follow along this tutorial you need to have basic knowledge of HTML, CSS, Javascript, Angular-JS
